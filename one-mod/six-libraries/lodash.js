...
let cars = [ 'Palio', 'Uno', 'gol', 'Savero', 'HB20', 'Creta', 'Nivus'];

//Retorna o primeiro e ultimo elemento
...
//Retornar um elemento aleatorio
...
//Repetir a execução de uma funcao
_.times(3, (i=0)=>{
  
  console.log(`Repetição ${i++}`);
})

//Atrasar a execuçao de uma função
