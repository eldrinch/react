...
function handlerChange() {
  ...
  if (country != "Global") {
    ...
    startDate = new Date(
      startDate.getFullYear(),
      startDate.getMonth(),
      //aqui para ficar com tres dias de diferença por isso colocamos o -1 do getDate() +1
      startDate.getDate() - 1,
      -3,
      0,
      0,
...
function loadData(data) {
  //calcular o valor diario precisa da informação de dois dias do dia selecionado e o dia anterior

  let yConfirmedDelta = data[1].Confirmed - data[0].Confirmed; //valor diario do dia anterior
  ...
  //informacao diaria do dia selecionado
